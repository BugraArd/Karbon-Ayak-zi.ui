...
export function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] bg-[#0a1628] flex flex-col items-center justify-center transition-opacity duration-600 ${
    ...
    >
      ...
      <div className="preloader-text text-center" style={{ animationDelay: '0.2s' }}>
        ...
        <p className="font-script text-2xl text-green-400">{preloaderConfig.brandSubname}</p>
      </div>
